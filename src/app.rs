    ...
    COMP: Component,
{
    ...
    fn mount_with_props_base(self, element: Element, props: COMP::Properties, use_ssr: bool) -> Scope<COMP> {
        clear_element(&element);
        if use_ssr {
            self.scope
                .mount_in_place_using_ssr(element, None, NodeRef::default(), props)
        } else {
            self.scope
    ...
    pub fn mount_with_props(self, element: Element, props: COMP::Properties) -> Scope<COMP> {
        self.mount_with_props_base(element, props, false)
    }
    ...
    pub fn mount_with_props_using_ssr(self, element: Element, props: COMP::Properties) -> Scope<COMP> {
        self.mount_with_props_base(element, props, true)
    }

    fn mount_to_body_with_props_base(self, props: COMP::Properties, use_ssr: bool) -> Scope<COMP> {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
            .expect("can't unwrap body node");
        if use_ssr {
            self.mount_with_props_using_ssr(element, props)
        } else {
    ...
    pub fn mount_to_body_with_props(self, props: COMP::Properties) -> Scope<COMP> {
        self.mount_to_body_with_props_base(props, false)
    }
    ...
    pub fn mount_to_body_with_props_using_ssr(self, props: COMP::Properties) -> Scope<COMP> {
        self.mount_to_body_with_props_base(props, true)
    }

    fn mount_as_body_with_props_base(self, props: COMP::Properties, use_ssr: bool) -> Scope<COMP> {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
        ...
        html_element
            ...
            .expect("can't remove body child");
        if use_ssr {
            self.scope.mount_in_place_using_ssr(
                html_element,
                None,
                NodeRef::default(),
                props
    ...
    pub fn mount_as_body_with_props(self, props: COMP::Properties) -> Scope<COMP> {
        self.mount_as_body_with_props_base(props, false)
    }
    ...
    pub fn mount_as_body_with_props_using_ssr(self, props: COMP::Properties) -> Scope<COMP> {
        self.mount_as_body_with_props_base(props, true)
    }
}
