...
use crate::context::{
    RenderingContext,
    get_current_rendering_context,
    set_current_rendering_context
};
    ...
    COMP::Properties: Default,
{
    ...
    pub fn mount(self, element: Element) -> Scope<COMP> {
        set_current_rendering_context(RenderingContext::Runtime);
    ...
    fn mount_base(self, element: Element) -> Scope<COMP> {
    ...
    fn mount_as_body_base(self) -> Scope<COMP> {
    ...
    COMP: Component,
{
    ...
    fn mount_with_props_base(self, element: Element, props: COMP::Properties) -> Scope<COMP> {
        clear_element(&element);
        self.scope
    ...
    fn mount_to_body_with_props_base(self, props: COMP::Properties) -> Scope<COMP> {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
    ...
    fn mount_as_body_with_props_base(self, props: COMP::Properties) -> Scope<COMP> {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
